...
def main() -> int:
    ...
    celah = [
        {"kolom": "Bidang studi", "sumber": "umat.dbf KET5", "kosong": bs_tt,
         ...
         "akibat": "Adegan 4.3 hanya memaparkan data umat yang memiliki catatan bidang studi secara terbuka."},
        {"kolom": "Penanda sekolah Katolik", "sumber": "umat.dbf KET4", "kosong": tanpa,
         "dari": N, "pct": pct(tanpa, N), "adegan": "4.2",
         "akibat": "Adegan 4.2 tidak menarik kesimpulan umum mengenai umat, melainkan menggarisbawahi besarnya data yang belum terdata."},
        {"kolom": "Golongan darah", "sumber": "umat.dbf KET7", "kosong": gd_tt,
         "dari": N, "pct": pct(gd_tt, N), "adegan": "5.6",
         "akibat": "Adegan 5.6 menyajikan kategori 'Tidak tercatat' sebagai batang tersendiri demi kejujuran data."},
        {"kolom": "Pekerjaan", "sumber": "umat.dbf KET6",
         ...
         "akibat": "Kategori 'Tidak tercatat' tetap ditampilkan dalam grafik untuk memperlihatkan proporsi data yang belum terisi."},
        {"kolom": "Tanggal krisma", "sumber": "umat.dbf TGLKRISMA",
         ...
         "akibat": "Tidak dibuat visualisasi berbasis tahun penerimaan krisma karena tingginya proporsi data kosong."},
        {"kolom": "Tanggal baptis", "sumber": "umat.dbf TGLBAPTIS",
         ...
         "akibat": "Tidak dibuat visualisasi berbasis tahun baptis demi menjaga akurasi analisis data."},
        {"kolom": "Jenis kelamin", "sumber": "umat.dbf KET1", "kosong": jk_tt,
         "dari": N, "pct": pct(jk_tt, N), "adegan": "2.1",
         "akibat": "Piramida usia mencantumkan secara terbuka jumlah jiwa yang belum dapat dikelompokkan menurut jenis kelamin."},
        {"kolom": "Tanggal lahir", "sumber": "umat.dbf TGLLAHIR",
         ...
         "akibat": "Umat yang usianya belum dapat dihitung karena ketiadaan tanggal lahir dicatat terpisah dari perhitungan utama."},
        {"kolom": "Tanggal nikah", "sumber": "umatkk.dbf TGLNIKAH",
         ...
         "akibat": "Tidak dibuat visualisasi berbasis tahun perkawinan demi menjaga keandalan informasi."},
    ]
    anomali = [
        {"temuan": "Baris dengan nama dan tanggal lahir identik",
         "jumlah": int(notes["dugaan_duplikat_baris"]),
         "kelompok": int(notes["dugaan_duplikat_kelompok"]),
         "perlakuan": "Ditandai dalam laporan validasi dan tidak dihapus otomatis demi kehati-hatian (mengingat kemungkinan kembar atau kesamaan nama). Dilaporkan sebagai dugaan data ganda untuk ditinjau oleh sekretariat paroki."},
        {"temuan": "Selisih jumlah keluarga antarsumber",
         "jumlah": N_KELUARGA - N_KK, "kelompok": None,
         "perlakuan": f"Berkas umat.dbf mencatat {N_KELUARGA} keluarga, sedangkan berkas umatkk.dbf mencatat {N_KK} keluarga. Analisis profil paroki secara konsisten memakai basis data umat.dbf ({N_KELUARGA} keluarga), dan setiap adegan yang merujuk berkas kepala keluarga senantiasa menyebutkan penyebutnya sendiri."},
        {"temuan": "Tanggal lahir di luar akal",
         "jumlah": int(notes["tgl_lahir_tak_masuk_akal"]), "kelompok": None,
         "perlakuan": "Dikeluarkan dari perhitungan usia dan dicatat dalam laporan validasi data."},
        {"temuan": "Tanggal nikah di luar akal",
         "jumlah": int(notes["tgl_nikah_tak_masuk_akal"]), "kelompok": None,
         "perlakuan": "Dikeluarkan dari analisis dan dicatat sebagai anomali penanggalan. Tahun yang ditemukan: "
        ...
        {"temuan": "Kepala keluarga tanpa catatan jenis kelamin",
         ...
         "perlakuan": f"Penyebut perhitungan adegan 1.5 adalah {kkjk_tercatat} kepala keluarga yang memiliki catatan, dan dicantumkan pada grafik."},
        {"temuan": "Baris berkode paroki lain",
         "jumlah": int(raw_counts["umat_luar_paroki"]), "kelompok": None,
         "perlakuan": "Tetap disertakan dalam total 12.614 jiwa terdaftar, namun dikeluarkan dari tabulasi agregasi tingkat wilayah dan lingkungan Pugeran; keterangan penyebut dinyatakan pada grafik wilayah."},
    ]
    penutup = {
        "celah_data": celah,
        "anomali": anomali,
        "usulan_pembaruan": [
            {"usul": "Melengkapi pencatatan data golongan darah warga", "besaran": gd_tt, "satuan": "jiwa", "adegan": "5.6"},
            {"usul": "Melengkapi data profesi dan pekerjaan umat", "besaran": int(pk_vc.get(TIDAK_TERCATAT, 0)), "satuan": "jiwa", "adegan": "4.4"},
            {"usul": "Verifikasi dan peninjauan langsung atas dugaan data ganda", "besaran": int(notes["dugaan_duplikat_kelompok"]), "satuan": "kelompok data", "adegan": None},
            {"usul": "Rekonsiliasi dan sinkronisasi data keluarga antardokumen sensus", "besaran": N_KELUARGA - N_KK, "satuan": "keluarga", "adegan": None},
            {"usul": "Mendata jenis sekolah (sekolah Katolik) guna mendukung perencanaan pastoral bidang pendidikan", "besaran": tanpa, "satuan": "jiwa", "adegan": "4.2"},
            {"usul": "Mencantumkan tanggal resmi ekstraksi pada setiap pembaruan data sensus berikutnya", "besaran": None, "satuan": None, "adegan": None},
        ],
    }
